...
E0_2005 <- read.csv("E0_2005.csv", stringsAsFactors = FALSE)
E0_2006 <- read.csv("E0_2006.csv", stringsAsFactors = FALSE)
E0_2007 <- read.csv("E0_2007.csv", stringsAsFactors = FALSE)
E0_2008 <- read.csv("E0_2008.csv", stringsAsFactors = FALSE)
E0_2009 <- read.csv("E0_2009.csv", stringsAsFactors = FALSE)
E0_2010 <- read.csv("E0_2010.csv", stringsAsFactors = FALSE)
E0_2011 <- read.csv("E0_2011.csv", stringsAsFactors = FALSE)
E0_2012 <- read.csv("E0_2012.csv", stringsAsFactors = FALSE)
E0_2013 <- read.csv("E0_2013.csv", stringsAsFactors = FALSE)
E0_2014 <- read.csv("E0_2014.csv", stringsAsFactors = FALSE)
```
...
```{r extract-stats-from-seasons, include = FALSE}
...
```{r function-for-league-and-gd, include = FALSE}
...
```{r extract-data-from-this-function, include = FALSE}
...
```{r combine-everything, include = FALSE}
...
save(df_all, file = "Data/processed_data.rda")
